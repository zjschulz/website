    ...
    return (
        <div className="Projects" id="Projects">
            ...
            <div class="accordion">
              <ul>
                <li>
                  <div> <a href="https://www.youtube.com/watch?v=ZyaNO0lgK18&t=13s" target="_blank">
                    <h2>Try Awarded</h2>
                ...
                <li>
                  <div> <a href="https://www.youtube.com/watch?v=R_NATOJQ8iA" target="_blank">
                    <h2>Yardsale</h2>
                    <p>Javascript single page application used to present multiple sellers’ items for purchase in one place.</p>
                    </a> </div>
                </li>
                <li>
                  <div> <a href="https://www.youtube.com/watch?v=ce2nz0LCxm4&t=15s" target="_blank">
                    <h2>Dog App</h2>
                    <p>Ruby on Rails application used to track volunteer dog walking hours.</p>
                    </a> </div>
                </li>
                <li>
                  <div> <a href="https://www.youtube.com/watch?v=kaYfgoIQWFQ" target="_blank">
